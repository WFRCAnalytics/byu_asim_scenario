...
& Write-Output "Config path: $arg1"
& Write-Output "Data path: $arg2"
& Write-Output "Output path: $arg3"

& conda activate ASIM_DEV

$parentDir = Split-Path -Parent $PSScriptRoot

$simulationPath = Join-Path $parentDir "/simulation.py"
$path1 = Join-Path $parentDir $arg1
$path2 = Join-Path $parentDir $arg2
$path3 = Join-Path $parentDir $arg3

if (python $simulationPath --config $arg1 --data $arg2 --output $arg3) {
    exit 1
}